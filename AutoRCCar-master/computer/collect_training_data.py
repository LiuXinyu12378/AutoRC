...
class CollectTrainingData(object):
    ...
    def __init__(self, host, port, serial_port, input_size):    #初始化数据收集
    ...
    def collect(self):                       #收集数据

        saved_frame = 0             #每次按键按下保存数据的个数
        total_frame = 0

        forward_num = 0             #记录前进，左右转的次数
        left_num = 0
        right_num = 0
